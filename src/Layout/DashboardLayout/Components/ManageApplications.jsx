    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="mb-6">
        <div className="bg-white rounded-lg shadow-sm p-6 border">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Scholarship Applications</h2>
      ...
      {applications.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm p-8 text-center border">
          ...
          <p className="text-gray-500">No scholarship applications submitted yet.</p>
        </div>
      ) : (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <p className="text-gray-700">{selectedApp.feedback || "No feedback provided yet."}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="mb-4 bg-blue-50 p-4 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">{selectedApp.applicantName}</div>
                    <div className="text-sm text-gray-600">{selectedApp.universityName}</div>
                  </div>
                </div>
              </div>
