    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">Loading your reviews...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-8xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-3">My Reviews</h1>
        ...
        {reviews.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <button className="bg-green-300 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-600 transition-colors shadow-lg">
              Browse Scholarships
            </button>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {reviews.map((review) => (
              ...
              >
                ...
                <div className="bg-linear-to-r from-green-500 to-[#009A64] p-6 text-white">
                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <button
                      ...
                      className="flex-1 bg-red-50 text-red-600 py-2 px-4 rounded-lg font-medium hover:bg-red-100 transition-colors flex items-center justify-center space-x-2"
                    >
                      <span>Delete</span>
                    </button>
                  </div>
        ...
        {reviews.length > 0 && (
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-100 rounded-xl shadow-lg p-6 text-center border border-gray-100">
        ...
        <div className="fixed inset-0  bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            <form onSubmit={handleUpdate}>
              <div className="bg-linear-to-r from-green-500 to-green-800 p-6 text-white rounded-t-2xl">
              ...
              <div className="px-6 pb-6 flex justify-end space-x-3">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 bg-primary text-black hover:bg-green-700 rounded-lg font-semibold transition-colors shadow-lg"
                >
                  Update Review
                </button>
              </div>
